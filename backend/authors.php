...
if (isset($_SESSION['user_id']) && !isLoginSessionExpired()) {
	...
	if ($_SERVER['REQUEST_METHOD']=='POST') {
		...
		$tablename = 'authors';
		insert($tablename,$new_author,$connection);
	}
								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<div class="dropdown card-title-btn-container">
											<button class="btn btn-sm btn-subtle" type="button" data-toggle="modal" data-target="#exampleModal"><em class="fa fa-plus"></em> Add author</button>
